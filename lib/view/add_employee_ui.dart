  ...
  void initState() {
    ...
    Future<void> createNewEmployee() async {
      ...
      try {
        final result = await supabaseService.createEmployee(
          ...
          workSiteId: _selectedWorkSiteId,      // ← เพิ่ม
    ...
    final isSelected = _employeeType == value;
    return Expanded(
      child: GestureDetector(
        onTap: () => setState(() => _employeeType = value),
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected
                  ? const Color(0xFF29B6F6).withOpacity(0.60)
          ...
          child: Row(
            ...
            children: [
              Icon(icon,
                  color: isSelected ? const Color(0xFF29B6F6) : Colors.white54,
                  size: 16),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 16),
                                        // ── Work Site Dropdown ──
                                          _sectionLabel('สถานที่ทำงาน (Work Site)'),
                                          const SizedBox(height: 8),
                                          Container(
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton<String?>(
                                                ...
                                                hint: Text('เลือกบริษัท/ร้านค้า',
                                                    style: TextStyle(color: Colors.white.withOpacity(0.28), fontSize: 14)),
                                                isExpanded: true,
                                                items: [
                                                  const DropdownMenuItem(value: null,
                                                      child: Text('ยังไม่กำหนด', style: TextStyle(color: Colors.white70))),
                                                  ..._workSites.map((site) => DropdownMenuItem<String>(
                                          ...
                                          _sectionLabel('ประเภทพนักงาน'),
                                          const SizedBox(height: 8),
                                          Row(
                                            children: [
                                              _typeChip('permanent', 'ประจำที่', Icons.work_rounded),
                                              const SizedBox(width: 10),
                                              _typeChip('daily', 'รายวัน', Icons.today_rounded),
                                            ],
